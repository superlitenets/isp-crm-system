...
class GenieACS {
    ...
    public function sendConnectionRequest(string $serial): array {
        ...
        if ($httpCode == 200) {
            return [
                'success' => true,
                'message' => 'Device responded - connection active',
...
PROVISION;
    ...
    public function clearConnectionRequestAuth(string $deviceId): array {
        ...
        error_log("[GenieACS] Setting Connection Request credentials for {$deviceId}");
    ...
    public function queueClearAuth(string $deviceId): array {
        ...
        error_log("[GenieACS] Queued CR credential push for {$deviceId} (will execute on next inform)");
