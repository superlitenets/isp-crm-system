...
function runMigrations(PDO $db): void {
    ...
    $columnMigrations = [
        ...
        ['huawei_onus', 'onu_type_id', 'ALTER TABLE huawei_onus ADD COLUMN onu_type_id INTEGER REFERENCES huawei_onu_types(id) ON DELETE SET NULL'],
        ['huawei_onus', 'port_config', 'ALTER TABLE huawei_onus ADD COLUMN port_config JSONB'],
        ['huawei_onus', 'smartolt_external_id', 'ALTER TABLE huawei_onus ADD COLUMN smartolt_external_id VARCHAR(100)'],
        ['huawei_onus', 'provisioning_stage', 'ALTER TABLE huawei_onus ADD COLUMN provisioning_stage INTEGER DEFAULT 0'],
