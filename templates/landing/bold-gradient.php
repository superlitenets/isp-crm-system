            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item ms-lg-2 dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end p-4 shadow" style="min-width: 300px; background: #fff; border-radius: 12px;">
                            <form method="POST" action="?page=login">
                                <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrfToken ?? '') ?>">
                                <div class="mb-3">
                                    <label class="form-label text-dark small fw-semibold">Email or Phone</label>
