...
<ul class="nav nav-tabs mb-4">
    ...
    <li class="nav-item">
        <a class="nav-link <?= $subpage === 'olt_scripts' ? 'active' : '' ?>" href="?page=settings&subpage=olt_scripts">
...
<?php if ($subpage === 'olt_scripts'): ?>

<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0"><i class="bi bi-magic me-2"></i>Fresh OLT Configuration Wizard</h4>
</div>
